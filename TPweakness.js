...
var Name_Weakness = function (Wname){
  ...
  for (currentName in data.pokemon){
    for (weakPoint in data.pokemon[currentName].weaknesses)  
      if (data.pokemon[currentName].weaknesses[weakPoint].toLowerCase() == Wname.toLowerCase()){

    		isNameFound = true

     		getName = data.pokemon[currentName].weaknesses
   		}
  }
    if (isNameFound == true){
      ...
      alert('There is no name in our system.')
...
var Wname = prompt('Enter Name to display Weaknesses')
Name_Weakness(Wname)
